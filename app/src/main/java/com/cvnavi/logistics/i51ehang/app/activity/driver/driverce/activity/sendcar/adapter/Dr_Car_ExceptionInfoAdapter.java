...
import com.cvnavi.logistics.i51ehang.app.activity.driver.driverce.activity.sendcar.Dr_Car_ExceptionInfoActivity;
 ...
 * Depict: 车辆异常
 */
public class Dr_Car_ExceptionInfoAdapter extends BaseAdapter {
    private List<ExceptionInfoBean> list;
    private LayoutInflater inflater;
    private Context mContext;

    public Dr_Car_ExceptionInfoAdapter(List<ExceptionInfoBean> list, Context context) {
        super();
        this.list = list;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final Dr_Car_ExceptionInfoActivity activity = (Dr_Car_ExceptionInfoActivity) mContext;
        if (convertView == null) {
        ...
        viewHolder.picLl.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                PreviewPicPagerActivity.start(activity, bean, PreviewPicPagerActivity.Car_Exception_Pic);
            }
        });
        return convertView;
    }

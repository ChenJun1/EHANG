...
public class HasStartedPlanFragment extends BaseFragment implements OnClickItemListener {
    ...
    private String Schedule_Status = "1";
    ...
    public static HasStartedPlanFragment getInstance() {
        return new HasStartedPlanFragment();
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        adapter = new DriverTransListViewAdapter(dataList, getActivity(), HasStartedPlanFragment.this);

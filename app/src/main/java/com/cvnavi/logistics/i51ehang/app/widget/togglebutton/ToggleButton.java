package com.cvnavi.logistics.i51ehang.app.widget.togglebutton;
...
import com.cvnavi.logistics.i51ehang.app.widget.togglebutton.facebook.SimpleSpringListener;
...
import com.cvnavi.logistics.i51ehang.app.widget.togglebutton.facebook.SpringUtil;
...
public class ToggleButton extends View {
     ...
     * 开启颜色
     */
    // private int onColor = Color.parseColor("#4cd863");
    private int onColor = Color.parseColor("#4cd863");
    /**
     * 关闭颜色
     */
    ...
    public void setToog(boolean animate){
        toggleOn = animate;
        takeEffect(animate);
    }
    /**

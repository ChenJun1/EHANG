package com.cvnavi.logistics.i51ehang.app.activity.driver.driverce.activity.sendgoods;
...
import com.cvnavi.logistics.i51ehang.app.activity.driver.driverce.activity.sendgoods.adapter.DrSendGoodsViewPagerAdapter;
import com.cvnavi.logistics.i51ehang.app.activity.driver.driverce.activity.sendgoods.fragment.DrAlreadSendGoodsFragment;
import com.cvnavi.logistics.i51ehang.app.activity.driver.driverce.activity.sendgoods.fragment.DrStaySendGoodsFragment;
 ...
 * Depict: 我的送货
 */
public class DrMySendGoods extends BaseActivity {

    private final int REQUESTCODE=10011; //请求码
    private static final int OFF_THE_STOCKS = 0; //未开始状态
    public static final int TOTAL = 1; //进行中状态
    ...
    private DrSendGoodsViewPagerAdapter pagerAdapter = null;
    private ArrayList<Fragment> fgList = null;

    public static void start(Context context) {
        Intent starter = new Intent(context, DrMySendGoods.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dr_send_goods_activity);
        ButterKnife.bind(this);
        mTitltTv.setText("我的送货");
        init();
    }
    ...
    private void init() {
        ...
        fgList.add(DrStaySendGoodsFragment.getInstance());
        fgList.add(DrAlreadSendGoodsFragment.getInstance());
        if (pagerAdapter == null) {
            pagerAdapter = new DrSendGoodsViewPagerAdapter(getSupportFragmentManager(), fgList);
        }

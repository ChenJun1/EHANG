...
public class DrCompleteFragment extends Fragment implements HandlerUtils.OnReceiveMessageListener{
    ...
    private DrCompleteAdpter adapter;
    ...
    public static DrCompleteFragment getInstance() {
        return new DrCompleteFragment();
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.dr_send_car_fragment3, container, false);
    ...
    public void init() {
        ...
        list = new ArrayList<>();
        if (adapter == null) {
            adapter = new DrCompleteAdpter(list, mContext);
        }

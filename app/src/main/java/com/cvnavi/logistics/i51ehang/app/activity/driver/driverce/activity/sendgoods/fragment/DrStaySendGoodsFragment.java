...
import com.cvnavi.logistics.i51ehang.app.activity.driver.driverce.activity.sendgoods.adapter.DrStaySendGoodsAdpter;
...
public class DrStaySendGoodsFragment extends Fragment implements HandlerUtils.OnReceiveMessageListener {
    ...
    private DrStaySendGoodsAdpter adapter;
    ...
    public static DrStaySendGoodsFragment getInstance() {
        return new DrStaySendGoodsFragment();
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.dr_send_goods_fragment1, container, false);
    ...
    public void init() {
       ...
       //设置可刷新加载属性
        ...
        list = new ArrayList<>();
        if (adapter == null) {
            adapter = new DrStaySendGoodsAdpter(list, getActivity());
        }
    ...
    private void loadDataRequest(final String Url) {
        ...
        RequestDataValueBean.IsDeliver = "0";//0表示 待发货状态

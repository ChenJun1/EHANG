...
import com.cvnavi.logistics.i51ehang.app.activity.cargo.adapter.home.unfinishedorder.DeliveryAdapter;
...
public class DeliveryFragment extends BaseFragment implements HandlerUtils.OnReceiveMessageListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.activity_delivery_fragment, container, false);
    ...
    private void initView() {
        ...
        mAdapter = new DeliveryAdapter(getContext(), mList);

...
public class HistorySendGoodsAdapter extends BaseAdapter {
    private List<GetSendGoodsRsponseBean.SendGoodsBean> list;
    private LayoutInflater mInflater;
    private Context mContext;

    public HistorySendGoodsAdapter(List<GetSendGoodsRsponseBean.SendGoodsBean> dataList, Context context) {
        super();
        this.list = dataList;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        HistorySendGoodsAdapter.ViewHolder viewHolder;
        ...
        if (convertView == null) {
            ...
            viewHolder = new HistorySendGoodsAdapter.ViewHolder(convertView);
            convertView.setTag(viewHolder);
        } else {
            viewHolder = (HistorySendGoodsAdapter.ViewHolder) convertView.getTag();
        }
        if (bean != null) {

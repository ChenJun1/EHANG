...
import com.cvnavi.logistics.i51ehang.app.activity.driver.driverce.activity.sendcar.adapter.DrNoStartAdpter;
...
public class DrNoStartFragment extends Fragment implements HandlerUtils.OnReceiveMessageListener {
    ...
    private DrNoStartAdpter adapter;
    ...
    public static DrNoStartFragment getInstance() {
        return new DrNoStartFragment();
    }

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.dr_send_car_fragment1, container, false);
    ...
    public void init() {
        ...
        list = new ArrayList<>();
        if (adapter == null) {
            adapter = new DrNoStartAdpter(list, mContext);
        }
    ...
    private void loadDataRequest(final String Url) {
        lodingDialog.show();
        mRquestBean.DeliverStatus = "0";//0标识未发车状态

...
import com.cvnavi.logistics.i51ehang.app.activity.driver.driverce.activity.takegoods.adapter.Dr_OrderExceptionInfoAdapter;
 ...
 * Depict: 货物异常信息页面
 */
public class Dr_OrderExceptionInfoActivity extends BaseActivity implements HandlerUtils.OnReceiveMessageListener{
    ...
    private Dr_OrderExceptionInfoAdapter adapter;
    ...
    public static void startActivity(Activity activity, String AllTicktNo) {
        Intent intent = new Intent(activity, Dr_OrderExceptionInfoActivity.class);
    ...
    private void init() {
        ...
        list = new ArrayList<>();
        adapter = new Dr_OrderExceptionInfoAdapter(list, this);
        ...
        loadDataRequest(DriverService.GetExceptInfo_Request_Url);//数据请求
    }
    ...
    public void handlerMessage(Message msg) {
        ...
        switch (msg.what) {
            ...
            case Constants.REQUEST_ERROR:
                DialogUtils.showMessageDialogOfDefaultSingleBtn(Dr_OrderExceptionInfoActivity.this, Utils.getResourcesString(R.string.request_error));
                break;
        }
    }
}

...
import com.cvnavi.logistics.i51ehang.app.bean.request.DelCarShiftRequest;
import com.cvnavi.logistics.i51ehang.app.bean.request.GetShiftListRequest;
import com.cvnavi.logistics.i51ehang.app.bean.response.DelCarShiftResponse;
...
public class ToStartPlanFragment extends BaseFragment implements OnClickItemListener {
    ...
    private String Schedule_Status = "0";//发车状态
    ...
    public static ToStartPlanFragment getInstance() {
        return new ToStartPlanFragment();
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        adapter = new DriverTransListViewAdapter(dataList, getActivity(), ToStartPlanFragment.this);
    ...
    @Subscribe(threadMode = ThreadMode.MAIN)
    public void refreshPlan(String addSucc) {
        isRefresh = true;
        getSchedulingList(freshStartTime, freshEndTime);
    }
    ...
    private void getSchedulingList(String beginDate, String endDate) {
        ...
        VolleyManager.newInstance().PostJsonRequest(TMSService.GetShiftList_TAG, TMSService.GetShiftList_Request_Url,
    ...
    public void onLongClick(mCarShift info, final int position) {
        ...
        if (Utils.checkOperate(Constants.EMPLOYEE_SERVICE_ID_DELECT_PLAN + "") || (!TextUtils.isEmpty(info.Add_Status) && !info.Add_Status.equals("0"))) {
            carInfo = info;

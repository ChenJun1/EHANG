...
public class SendCarsStatics extends BaseActivity {
    ...
    public static void start(Context context) {
        Intent starter = new Intent(context, SendCarsStatics.class);
...
//        lineChart.setMarkerView(myMarkView);
        ...
        if (sList.DetailList != null && sList.DetailList.size() > 0) {
            for (int i = 0; i < sList.DetailList.size(); i++) {
                ...
                xValues.add(DateUtil.strOldFormat2NewFormat(list.Letter_DateStr, DateUtil.FORMAT_YMD, DateUtil.FORMAT_MD));
                yValue.add(new Entry(Float.parseFloat(list.DayCarCount), i));
            }
        }
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.back_ll:
                ...
                break;
            case R.id.right_tv:
                SendCarDetailActivity.start(SendCarsStatics.this, mStarTime, mEendTime);
                break;
            case R.id.data_search_layout:
                ...
                MyPopWindow popWindow = new MyPopWindow(SendCarsStatics.this, item);
                    ...
                    public void onClick(int pos) {
                        switch (pos) {
                            ...
                            case 2:
                                ...
                                break;
                            case 3:
                                DriverCarSchedulingSearchActivity.startActivity(SendCarsStatics.this, F_REQUEST_CODE);
                                break;
                        }
    ...
    private void requestHttp() {
        ...
        VolleyManager.newInstance().PostJsonRequest("--->", EmployeeService.GetReadCarStatistics_Url, jsonObject, new Response.Listener<JSONObject>() {
            @Override
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case Constants.REQUEST_ERROR:
                    DialogUtils.showMessageDialogOfDefaultSingleBtn(SendCarsStatics.this, Utils.getResourcesString(R.string.request_error));
                    break;
            }
        }
    };

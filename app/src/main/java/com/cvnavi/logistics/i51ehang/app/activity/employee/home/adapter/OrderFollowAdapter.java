...
public class OrderFollowAdapter extends BaseAdapter {
    ...
    public OrderFollowAdapter(List<LogisticsFollowNoteBean> list, Context context) {
        super();
        this.list = list;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final OrderFollowActivity activity= (OrderFollowActivity) mContext;
        OrderFollowAdapter.ViewHolder viewHolder;
        if (convertView == null) {
            convertView = inflater.inflate(R.layout.item_logistics_follow, null);
            viewHolder = new OrderFollowAdapter.ViewHolder(convertView);
            convertView.setTag(viewHolder);
        } else {
            viewHolder = (OrderFollowAdapter.ViewHolder) convertView.getTag();
        }

...
import com.cvnavi.logistics.i51ehang.app.activity.cargo.adapter.home.unfinishedorder.InTransitAdapter;
...
public class InTransitFragment extends BaseFragment implements HandlerUtils.OnReceiveMessageListener{
    ...
    public static InTransitFragment getInstance() {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.activity_intransit_fragment, container, false);
    ...
    private void initView() {
        ...
        mAdapter = new InTransitAdapter(getContext(), mList);

...
import com.cvnavi.logistics.i51ehang.app.activity.driver.driverce.activity.takegoods.adapter.DrAlreadTakeGoodsAdpter;
...
public class DrAlreadTakeGoodsFragment extends Fragment implements HandlerUtils.OnReceiveMessageListener {
    ...
    private DrAlreadTakeGoodsAdpter adapter;
    ...
    public static DrAlreadTakeGoodsFragment getInstance() {
        return new DrAlreadTakeGoodsFragment();
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.dr_take_goods_fragment2, container, false);
    ...
    public void init() {
        ...
        if (adapter == null) {
            adapter = new DrAlreadTakeGoodsAdpter(list, getActivity());
        }

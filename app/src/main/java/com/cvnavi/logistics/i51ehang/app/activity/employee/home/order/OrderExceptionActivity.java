...
public class OrderExceptionActivity extends BaseActivity {
    ...
    public static void startActivity(Activity activity, String AllTicktNo) {
        Intent intent = new Intent(activity, OrderExceptionActivity.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_employee_order_exception);
    ...
    private void loadDataRequest(final String Url) {
        ...
        dataRequestBase.DataValue = reqest;
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case Constants.REQUEST_ERROR:
                    DialogUtils.showMessageDialogOfDefaultSingleBtn(OrderExceptionActivity.this, Utils.getResourcesString(R.string.request_error));
                    break;
            }
        }
    };

...
public class HistoryTakeGoodsAdapter extends BaseAdapter {
    private List<GetTakeGoodsResponseBean.TakeBean> list;
    private LayoutInflater mInflater;
    private Context mContext;

    public HistoryTakeGoodsAdapter(List<GetTakeGoodsResponseBean.TakeBean> dataList, Context context) {
        super();
        this.list = dataList;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        HistoryTakeGoodsAdapter.ViewHolder viewHolder;
        if (convertView == null) {
            convertView = mInflater.inflate(R.layout.dr_take_goods_item2, null);
            viewHolder = new HistoryTakeGoodsAdapter.ViewHolder(convertView);
            convertView.setTag(viewHolder);
        } else {
            viewHolder = (HistoryTakeGoodsAdapter.ViewHolder) convertView.getTag();
        }
        if (bean != null) {

...
public class SwipeBackLayout extends FrameLayout {
    ...
    private ActivityFinishStateListener listener = null;
    ...
    public void setActivityFinishListener(ActivityFinishStateListener listener) {
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if (mContentView.getScrollX() <= -viewWidth / 2) {
                    if (listener != null && !listener.isCanFinishActivity()) {
                        scrollOrigin();
                    } else {
                        isFinish = true;
                        scrollRight();
